...
export const NftDetials = ({ ...props }) => {
  ...
  const ErrorContent = !item && !isLoadingDetial && (
      ...
      <div className={classes["content-box"]}>
        ...
        <div className={classes["stats-box"]}>
          ...
          <p>
            ...
            <span>
              {item.number_of_unique_addresses_24h_percentage_change.toFixed(2)}{" "}
              %
            </span>
          </p>
          <p>
  ...
  const LoadingContent = isLoadingDetial && <LoadingSpinner />;
  return (
    <>
      {LoadingContent}
      {ItemContent}
